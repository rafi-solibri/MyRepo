...
## Hirist Daily 9 AM
https://cursor.com/automations/566599f1-a2a4-11f1-b532-320a589b8025

Created and enabled. Paste once if the Automations UI still has a stale prompt:
...
Session cookie is `hirist_seeker_enc` (refreshed into `.portal-sessions` after the 2026-08-28 post-fix re-run). If cron boots logged out: `bash scripts/home-headed-login.sh hirist` then Save Environment snapshot.
