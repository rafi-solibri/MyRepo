...
| Issue | Fix |
| --- | --- |
| TITLE_OK allowed QA Architect and Interior Architect (B.Arch) | Blacklist qa architect and interior/B.Arch titles |
| TITLE_OK missed Senior Manager - Software Engineering (hyphen-led) | Allow manager[-–,:] software development/engineering titles |
