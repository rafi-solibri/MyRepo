...
| Issue | Fix |
| --- | --- |
| GSI identifier form + rejected password looked like generic login timeout | Fill Google identifier/password; detect wrong-password copy; try unique secret aliases; per-method wait |
