...
| Issue | Fix |
| --- | --- |
| TITLE_OK allowed Junior Architect (1-2 years) at a design studio | Blacklist junior architect and 1-2 years titles |
| TITLE_OK allowed Remote Senior Software Engineer – Python (wrong stack) | Blacklist software engineer + Python titles |
