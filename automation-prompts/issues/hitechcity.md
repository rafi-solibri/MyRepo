...
| Issue | Fix |
| --- | --- |
| Naukri recommended/homepage inventory applied off-campus Chennai consultancy (Software Product / Sangathr) | Enforce campus company allowlist on recommended+homepage pass (search path already had it) |
