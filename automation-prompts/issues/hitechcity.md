...
| Issue | Fix |
| --- | --- |
| Oracle Fusion Load Testing title leaked on LinkedIn (careers already skipped it) | Copy performance/load/fusion-load-testing skips into LI_TITLE_SKIP |
| Micron Staff Engineer IP Dev Layout leaked past layout-engineer skip | Title-skip ip dev layout / dev layout on CAREERS + LI |
