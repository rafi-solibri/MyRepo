...
| Issue | Fix |
| --- | --- |
| Oracle /apply/email timed out (honey-pot + hidden terms); Gartner (Remote- US) opened as India-remote | Fill Oracle email+AGREE+NEXT, fail-fast ats_email_otp; BAD_LOC_HINT Remote-US/U.S. |
