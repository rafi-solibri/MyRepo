...
| Issue | Fix |
| --- | --- |
| Gmail CDP tab hit accounts.google.com so #264 OTP reader timed out (no IMAP app password) | email_otp.py: try Google identifier+password from GOOGLE_PASSWORD/LINKEDIN_PASSWORD then re-open search |
