...
| Issue | Fix |
| --- | --- |
| Micron silicon/layout/DRAM/HBM/design-verification titles matched Staff/Principal and burned persist_retry; Flutter/LTIMindtree career hosts DNS/cert-fail; careers ignored MAX_SOFT_INCOMPLETE so OWNER_ASLEEP could not stop the loop | CAREERS_TITLE_SKIP+LI_TITLE_SKIP silicon/layout/DRAM/HBM/NVM/staff-analyst; honor MAX_SOFT_INCOMPLETE in careers_apply; replace careers.flutter.com→fluttergroup.com and careers.ltimindtree.com→careers.ltm.com |
