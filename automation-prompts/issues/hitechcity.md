...
| Issue | Fix |
| --- | --- |
| All 18 LinkedIn people-referral rows blocked: More button click intercepted/timeout 1500ms | Force-click More and Connect CTAs so overlay cannot steal the referral note send |
