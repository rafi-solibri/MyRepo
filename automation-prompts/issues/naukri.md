...
| Issue | Fix |
| --- | --- |
| Staff Analog Engineer false-applied; per-job tailor profile upload/restore timed out (60s goto + leftover Cutshort/profile tabs) | skip analog/ASIC/VLSI hardware titles; reuse profile tab + commit goto; prune foreign tabs before profile sync |
