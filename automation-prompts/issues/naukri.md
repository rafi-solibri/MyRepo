...
| Issue | Fix |
| --- | --- |
| view_applied_jobs treated as Applied (TCS Data SA + Tech Mahindra TL false-confirmed); Data Solution Architect not skipped | Do not treat View applied jobs as success; skip data solution architect titles |
