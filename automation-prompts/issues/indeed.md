...
| Issue | Fix |
| --- | --- |
| WSA expected CTC still empty: labelFor wrap truncated to Current CTC only | fieldBits uses placeholder/sibling/parent; pair-fill empty salary box after current 52 |
