...
| SmartApply rejected all DOCX (tailored/compressed/3.9MB master) on Genpact resume-selection | PDF fallback succeeded: Rafi_Resume.pdf uploaded just now; Genpact Technical Architect 4D APPLIED; prefer PDF first |
