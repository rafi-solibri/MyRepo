...
| Issue | Fix |
| --- | --- |
| bot-detection Sign In viewjob hops skipped as title_not_target; UTC date stamped 2026-08-23 after IST midnight | restore session + retry continue2 before title skip; IST date on indeed-daily-run.json |
