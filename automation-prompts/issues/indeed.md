...
| Issue | Fix |
| --- | --- |
| Passport JWT expired; in.indeed.com stayed anonymous after CDP cookie inject | Hop to secure.indeed.com/settings/account so rememberMe refreshes OAuth, then return to India home |
