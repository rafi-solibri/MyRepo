...
| Cutshort scanned ~1974 with **0 qualifying** after apply burst; maxExp&lt;8 dropped 5–7 Architect bands; Hyd-only location missed title-remote | Tier1 allows maxExp≥6; title/Telangana/remote location bias; keyword scan waves (`architect` / `tech lead` / `.net` / EM); stop counting historical locked-empty Qs as rejected |
