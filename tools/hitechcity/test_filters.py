...
def test_title_ok():
    ...
    assert CAREERS_TITLE_SKIP.search("Senior /Staff AMS Layout engineer-DPG-LPDDR")
    assert LI_TITLE_SKIP.search("Senior /Staff AMS Layout engineer-DPG-LPDDR")
    assert CAREERS_TITLE_SKIP.search("Senior/Staff Engineer, Technology - AMAIS")
    assert LI_TITLE_SKIP.search("Senior/Staff Engineer, Technology - AMAIS")
    assert not CAREERS_TITLE_SKIP.search("Staff Software Engineer, Technology Platform")
    ...
    assert LI_TITLE_SKIP.search(
        "Principal Performance Test Engineer (Fusion Load Testing)"
    )
    ...
    assert CAREERS_TITLE_SKIP.search("Memory Systems Performance & Workload Architect - SMTS")
    assert LI_TITLE_SKIP.search("Memory Systems Performance & Workload Architect - SMTS")
    assert CAREERS_TITLE_SKIP.search("Staff Engineer , Analog Design")
    assert LI_TITLE_SKIP.search("Staff Engineer , Analog Design")
    assert CAREERS_TITLE_SKIP.search("STAFF ENGINEER, DDEG Design Methodology")
