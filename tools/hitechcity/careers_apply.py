...
CAREERS_TITLE_SKIP = re.compile(
    ...
    # Micron memory-architecture System Architect (not application/.NET architect).
    r"memory\s*system\s*architecture|advanced\s*memory|\bdmts\b|"
