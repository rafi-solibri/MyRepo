...
class _FakeFramePage:
    def __init__(self):
        ...
        self.frames = [self.main_frame, object()]


targets = list(_otp_targets(_FakeFramePage()))
assert_true(len(targets) == 2, f"otp targets include page + extra frame, got {len(targets)}")
