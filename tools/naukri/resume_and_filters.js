 ...
 */
const SKIP_TITLE_RE =
  /\b(qa engineer|qa automation|quality assurance|quality engineer|quality engineering|quality architect|quality solution architect|\bqe\b|sdet|tosca|test automation architect|embedded\b|firmware|intern(?!et)|fresher|salesforce|agentforce|servicenow|coupa|pega|lead system architect|\blsa\b|appian|anaplan|celonis|power platform|power apps|mulesoft|guidewire|sap\b|dynamics|\bd365\b|workday hcm|workday hms|revit|\bbarch\b|hubspot|\bsre\b|site reliability|devops engineer|devops lead|platform sre|network operations|network ops|network support|civil\b|structural|substation|attack surface|cyber\s*security|cybersecurity|cyber architecture|cloud security|security architect|infosec|penetration|red team|soc analyst|security operations|threat hunter|\bmdr\b|\bedr\b)\b/i;
