...
const NON_DOTNET_PRIMARY_RE =
  /\b(java|j2ee|spring boot|golang|go lang|python|node\.?js|mean\b|mern\b|ruby on rails|php|oracle apps|oracle fusion|oracle\s+dba|oracle cloud|oracle\s+epm|oracle\s+paas|oracle\s+hcm|oracle\s+erp|oracle\s+ebs|oracle\s+apex|\bapex\s+(?:solution\s+)?architect|\bnetsuite\b|fusion\s+hcm|abap|mainframe|cobol|\bas400\b|ibm\s*i)\b/i;
