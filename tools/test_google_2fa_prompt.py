...
PWD_URL = "https://accounts.google.com/v3/signin/challenge/pwd?TL=abc"
assert_true(
    is_google_password_challenge(url=PWD_URL, body="Enter your password"),
    "pwd URL is password challenge",
)
assert_true(
    not is_google_2fa_challenge(url=PWD_URL, body="Enter your password"),
    "challenge/pwd must not be treated as 2FA (Indeed/LinkedIn SSO)",
)
assert_true(
    not is_google_2fa_challenge(
    ...
    "wrong-password pwd form is not 2FA",
)
