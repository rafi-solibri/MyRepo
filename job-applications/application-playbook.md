...
**Last refreshed:** 2026-08-05 06:38 UTC cron

## Why applications were not submitted this run

Configured automation delivery channels = **git PR (`open_git_pr`) + `automation_memory`**.  
No LinkedIn, Naukri, email, Slack, or browser-login apply tools are attached. Submitting resume/PII to external ATS from this agent is **not an allowed delivery destination**.

**To enable auto-apply:** open https://cursor.com/automations/30e2c023-9067-11f1-ba66-0e7d0216e441 and add job-board / authenticated browser / email + a Slack or email notification action.

## Manual apply checklist (60–90 min)

1. Open cover letters + three resume variants; export to PDF (remove HTML comments / notes):
...
2. Apply Priority A in `job-shortlist.md` (Deloitte×2, Experian, UHG Eng Lead, ServiceNow Sr Staff).
...
- Best band clearance: Experian, ServiceNow Staff/Principal, Microsoft, Amazon Principal, Verisk product architect; Deloitte senior SA if negotiated hard.
- Skip posted ≤38 LPA and 30–35 LPA listings.
